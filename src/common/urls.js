...
const getIssues = `${YOUTRACK_URL}/api/issues?fields=id,idReadable,summary,project(shortName,name),customFields(id,projectCustomField(id,field(id,name)),value(id,minutes,presentation))&query=for:%20me%20%23Unresolved%20sort%20by:%20created%20desc`;
